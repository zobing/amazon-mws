 ...
 ***********************************************************************/
 ...
 invokeCreateShipment($service, $request);

/**
  * Get Create Shipment Action Sample
  ...
  * @param mixed $request MWSMerchantFulfillmentService_Model_CreateShipment or array of parameters
  */

  function invokeCreateShipment(MWSMerchantFulfillmentService_Interface $service, $request)
  {
      try {
