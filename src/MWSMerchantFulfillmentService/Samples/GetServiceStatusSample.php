 ...
 ***********************************************************************/
 // @TODO: set request. Action can be passed as MWSMerchantFulfillmentService_Model_GetServiceStatus
 $request = new MWSMerchantFulfillmentService_Model_GetServiceStatusRequest();
...
/**
  ...
  * @param mixed $request MWSMerchantFulfillmentService_Model_GetServiceStatus or array of parameters
  */

  function invokeGetServiceStatus(MWSMerchantFulfillmentService_Interface $service, $request)
  {
      try {
