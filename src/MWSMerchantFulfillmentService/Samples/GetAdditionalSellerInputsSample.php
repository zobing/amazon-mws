...
/**
 * Get Additional Seller Inputs Sample
 */
 ...
 * sample for Get Additional Seller Inputs Action
 ***********************************************************************/
 // @TODO: set request. Action can be passed as MWSMerchantFulfillmentService_Model_GetAdditionalSellerInputs
 $request = new MWSMerchantFulfillmentService_Model_GetAdditionalSellerInputsRequest();
 $request->setSellerId(MERCHANT_ID);
 // object or array of parameters
 invokeGetAdditionalSellerInputs($service, $request);

/**
  * Get Get Additional Seller Inputs Action Sample
  ...
  * @param mixed $request MWSMerchantFulfillmentService_Model_GetAdditionalSellerInputs or array of parameters
  */

  function invokeGetAdditionalSellerInputs(MWSMerchantFulfillmentService_Interface $service, $request)
  {
      try {
        $response = $service->GetAdditionalSellerInputs($request);
